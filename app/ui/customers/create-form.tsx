...
import { createPuppyRequest } from "@/app/lib/actions";
...
export default function CreateForm({ date }: { date: string }) {
  ...
  const [state, formAction] = useActionState(createPuppyRequest, initialState);
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                type="text"
                step="0.01"
                defaultValue={state.formData?.ownerFirstName}
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                type="text"
                step="0.01"
                defaultValue={state.formData?.ownerLastName}
                className="peer block rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500 w-full"
                aria-describedby="customer-error"
              />
              <UserCircleIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500" />
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                type="text"
                step="0.01"
                defaultValue={state.formData?.dogName}
            ...
            <fieldset aria-describedby="customer-error">
              ...
              <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
                <div className="flex flex-col gap-4">
                  {Object.values(PuppyService).map((service) => (
                    <div className="flex items-center" key={service}>
                      <input
                        ...
                        type="checkbox"
                        value={service}
                        defaultChecked={state.formData?.services?.includes(service)}
